...
struct SessionView: View {
    ...
    @State private var pendingCrash: UIKitSampleCrashScenario?
    ...
    var body: some View {
        List {
            ...
            Section("Crash Simulation") {
                ...
                ForEach(UIKitSampleCrashScenario.allCases) { scenario in
...
private enum UIKitSampleCrashScenario: String, CaseIterable, Identifiable {
    ...
    func trigger() -> Never {
        switch self {
        case .swiftFatalError:
            fatalError("Sample crash — Swift fatalError from UIKit SessionView")
        case .nsException:
            NSException(
                name: .genericException,
                reason: "Sample crash — NSException from UIKit SessionView",
                userInfo: nil
            ).raise()
