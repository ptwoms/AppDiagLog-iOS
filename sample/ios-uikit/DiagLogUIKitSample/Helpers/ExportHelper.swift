...
enum ExportHelper {
    @MainActor static func shareExport(zipURL: URL, presentingFrom sourceViewController: UIViewController? = nil) {
    ...
    @MainActor private static func topMostController() -> UIViewController? {
