        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(spacing: 12) {
                        actionButton(
                            title: "Debug: Cache Hit",
                            systemImage: "ladybug",
                            tint: .teal
                        ) {
                            AppDiagLog.debug(
                                "cache_lookup_debug",
                                ["cache": "user_profile", "result": "hit", "source": "swiftui_sample"]
                            )
                            appendAction("Logged debug cache lookup event.")
                        }

                        actionButton(
                            title: "Info: Checkout Started",
                            systemImage: "cart",
                            tint: .blue
                        ) {
                            AppDiagLog.info(
                                "checkout_started",
                                ["step": "shipping", "flow": "guest", "source": "swiftui_sample"]
                            )
                        ...
                        actionButton(
                            ...
                            AppDiagLog.warning(
                                "slow_render_warning",
                                ["screen": "ProductList", "frame_ms": "42", "source": "swiftui_sample"]
                            )
                            appendAction("Logged warning slow render event.")
                        }

                        actionButton(
                            title: "Error: Payment Failure",
                            systemImage: "xmark.octagon",
                            tint: .red
                        ) {
                            AppDiagLog.error(
                                "payment_authorization_failed",
                                ["status": "500", "provider": "sandbox", "source": "swiftui_sample"]
                            )
